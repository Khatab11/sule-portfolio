  ...
  singletons: {
    siteSettings: singleton({
      ...
      schema: {
        ...
        heroGreeting: fields.text({ label: 'Homepage greeting (e.g. "Hey, I\'m Şule 👋")' }),
        heroSubtitle: fields.text({ label: 'Homepage subtitle', multiline: true }),
        welcomeMessage: fields.text({ label: 'Welcome typewriter message', multiline: true }),
        cvHeroImage: fields.image({
          label: 'CV page hero photo',
          directory: 'public/images',
          publicPath: '/images/',
        }),
        contactHeroImage: fields.image({
          label: 'Contact page hero photo',
          directory: 'public/images',
          publicPath: '/images/',
        }),
        publicationsHeroImage: fields.image({
          label: 'Publications page hero photo',
          directory: 'public/images',
          publicPath: '/images/',
        }),
        ...
        officeLocation: fields.text({ label: 'Office location short line' }),
        hIndex: fields.text({ label: 'H-index (for CV hero)' }),
        citations: fields.text({ label: 'Citations count' }),
        publicationCount: fields.text({ label: 'Publications count (e.g. "90+")' }),
        footerText: fields.text({ label: 'Footer copyright text', multiline: true }),
        footerTagline: fields.text({ label: 'Footer tagline (e.g. department)' }),
      },
    }),
  },
  ...
  collections: {
    ...
    publications: collection({
      ...
      schema: {
        ...
        ref: fields.text({ label: 'CV citation reference (authors, year)' }),
        detail: fields.text({ label: 'CV citation detail (volume, pages)' }),
        cvSection: fields.select({
          label: 'CV Selected Publications section',
          options: [
            { label: '— Not shown on CV —', value: 'none' },
            { label: 'Digital Psychology', value: 'digital' },
